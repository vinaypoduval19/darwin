...
export const datePickerDarkStyle = () => {
  ...
  return {
    ...
    '&.small': {
      '& .MuiOutlinedInput-input': {
        padding: `${input_field.ds_input_field_small_vertical_spacing}px ${input_field.ds_input_field_small_horizontal_spacing}px`,
        height: `${input_field.ds_input_field_small_input_box_height}px`,
        boxSizing: 'content-box'
      },
      '& .MuiInputLabel': {
        '&-root': {
        ...
        '&-shrink': {
          ...
          paddingRight: `${input_field.ds_input_field_label_background_horizontal_spacing}px`,
          background:
            input_field.input_field.background
...
export const datePickerPoperDarkStyle = () => {
  // eslint-disable-next-line
