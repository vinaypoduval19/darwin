...
const aliasTokenLightTheme = {
  ...
  background: {
    cta_primary: {
      ...
      ds_alias_cta_primary_selected_background_color:
        globalToken.color.ds_global_color_blue_10
    },
    cta_secondary: {
      ...
      ds_alias_cta_secondary_selected_background_color:
        globalToken.color.ds_global_color_neutral_30,
    ...
    cta_accent: {
      ds_alias_cta_error_background_color:
        globalToken.color.ds_global_color_red_70,
      ds_alias_cta_success_background_color:
        globalToken.color.ds_global_color_green_70
    },
    generic: {
      ds_alias_success_background_color:
        globalToken.color.ds_global_color_green_20,
      ds_alias_error_background_color: globalToken.color.ds_global_color_red_20,
      ds_alias_warning_background_color:
        globalToken.color.ds_global_color_yellow_20,
      ds_alias_information_background_color:
        globalToken.color.ds_global_color_purple_20,
    ...
    surface: {
      ...
      ds_alias_surface_gradient3_background_color:
        globalToken.color.ds_global_color_white_30_gradient3,
      ds_alias_surface_gradient1_background_color:
        globalToken.color.ds_global_color_white_10_gradient4,
      ds_alias_surface_gradient2_background_color:
        globalToken.color.ds_global_color_white_10_gradient5
    }
  },
  text: {
    cta_primary: {
    ...
    cta_accent: {
      ds_alias_cta_success_text_color:
        globalToken.color.ds_global_color_green_70,
      ds_alias_cta_error_text_color: globalToken.color.ds_global_color_red_70
    },
    onsurface: {
      ds_alias_onsurface_default1_text_color:
        globalToken.color.ds_global_color_neutral_90,
      ds_alias_onsurface_default2_text_color:
        globalToken.color.ds_global_color_neutral_60,
    ...
    accent: {
      ds_alias_success_text_color: globalToken.color.ds_global_color_green_70,
      ds_alias_error_text_color: globalToken.color.ds_global_color_red_70,
      ds_alias_warning_text_color: globalToken.color.ds_global_color_yellow_70,
      ds_alias_information_text_color:
        globalToken.color.ds_global_color_purple_70
    }
  },
  border: {
    cta_primary: {
    ...
    cta_accent: {
      ds_alias_cta_success_border_color:
        globalToken.color.ds_global_color_green_70,
      ds_alias_cta_error_border_color: globalToken.color.ds_global_color_red_70,
      ds_alias_cta_focus_border_color: globalToken.color.ds_global_color_blue_70
    },
    surface: {
      ds_alias_surface1_border_color: globalToken.color.ds_global_color_blue_70,
    ...
    accent: {
      ds_alias_success_border_color: globalToken.color.ds_global_color_green_70,
      ds_alias_error_border_color: globalToken.color.ds_global_color_red_70,
  ...
  icon: {
    ...
    cta_secondary: {
      ...
      ds_alias_cta_secondary_default3_icon_color:
        globalToken.color.ds_global_color_neutral_70,
      ds_alias_cta_secondary_disabled_icon_color:
        globalToken.color.ds_global_color_neutral_30
    },
    accent: {
      ds_alias_success_icon_color: globalToken.color.ds_global_color_green_70,
      ds_alias_error_icon_color: globalToken.color.ds_global_color_red_70,
      ds_alias_information_icon_color:
        globalToken.color.ds_global_color_purple_70,
      ds_alias_warning_icon_color: globalToken.color.ds_global_color_yellow_70,
      ds_alias_default_icon_color: globalToken.color.ds_global_color_neutral_60
    },
    cta_accent: {
      ds_alias_cta_success_icon_color:
        globalToken.color.ds_global_color_green_70,
      ds_alias_cta_error_icon_color: globalToken.color.ds_global_color_red_70
    },
    onsurface: {
  ...
  font: {
    ...
    line_height: {
      ...
      ds_alias_font_line_height_56:
        globalToken.font.ds_global_font_line_height_56,
      ds_alias_font_line_height_64:
        globalToken.font.ds_global_font_line_height_64
    },
    size: {
      ...
      ds_alias_font_size_44: globalToken.font.ds_global_font_size_44,
      ds_alias_font_size_56: globalToken.font.ds_global_font_size_56
    },
    transform: {
...
export default aliasTokenLightTheme
