...
const search = searchTheme('light')
const typography = typographyTheme('light')
const dropdownMenu = dropdown_menuTheme('light')
const dropdownList = dropdown_listTheme('light')
export const stylesLightThemeSearch = {
  '&.medium': {
...
export const stylesLightSearchInputStyle = {
  '& .MuiOutlinedInput-root': {
    background: search.search_by.ds_search_by_background_color,
...
const stylesLightTheme = createUseStyles({
  menuBox: {
    minWidth: 'max-content',
...
export const styleLightThemeListItem = {
...
export const stylesLightThemeSearchListStyle = {
  marginTop: `${dropdownMenu.ds_dropdown_menu_vertical_spacing}px`,
