...
export const autoCompleteDarkStyle = (size) => {
...
export const autoCompletePaperDarkStyle = () => {
  const divider = dividerTheme('dark')
  const typography = typographyTheme('dark')
  // eslint-disable-next-line @typescript-eslint/naming-convention
  const dropdown_list = dropdown_listTheme('dark')
  // eslint-disable-next-line @typescript-eslint/naming-convention
...
export const inputDarkStyles = (disabled) => {
  // eslint-disable-next-line
  const input_field = input_fieldTheme('dark')
  const divider = dividerTheme('dark')
  const typography = typographyTheme('dark')
