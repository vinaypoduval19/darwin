...
export const DeleteClusterInputSchema = t.partial({
  input: t.union([
    t.undefined,
    t.null,
...
export const SelectionOnDeleteClusterSchema = t.type({
  status: t.union([t.null, t.string]),
  data: t.union([t.null, t.type({cluster_id: t.union([t.null, t.string])})]),
})

export const DeleteClusterSchema = t.type({
  deleteCluster: t.union([
    t.null,
    t.type({
      status: t.union([t.null, t.string]),
      data: t.union([
