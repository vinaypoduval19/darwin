...
export const ReStartClusterInputSchema = t.partial({
  input: t.union([
    t.undefined,
    t.null,
...
export const SelectionOnReStartClusterSchema = t.type({
  status: t.union([t.null, t.string]),
  data: t.union([t.null, t.type({cluster_id: t.union([t.null, t.string])})]),
})

export const ReStartClusterSchema = t.type({
  reStartCluster: t.union([
    t.null,
    t.type({
      status: t.union([t.null, t.string]),
      data: t.union([
