...
export const CreateProjectInputSchema = t.partial({
...
export const SelectionOnCreateProjectSchema = t.type({
...
export const CreateProjectSchema = t.type({
  createProject: t.union([
    t.null,
    t.type({
      project_id: t.union([t.null, t.string]),
      project_name: t.union([t.null, t.string]),
