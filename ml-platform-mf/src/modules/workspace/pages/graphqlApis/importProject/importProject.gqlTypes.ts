...
export const ImportProjectInputSchema = t.partial({
  githubUrl: t.union([t.undefined, t.null, t.string]),
...
export const SelectionOnImportProjectSchema = t.type({
...
export const ImportProjectSchema = t.type({
  importProject: t.union([
    t.null,
    t.type({
      project_id: t.union([t.null, t.string]),
      project_name: t.union([t.null, t.string]),
