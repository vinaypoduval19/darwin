...
export const AttachClusterInputSchema = t.partial({
...
export const SelectionOnAttachClusterSchema = t.type({
...
export const AttachClusterSchema = t.type({
  attachCluster: t.union([
    t.null,
    t.type({
      project_id: t.union([t.null, t.string]),
      project_name: t.union([t.null, t.string]),
