...
export const LaunchCodespaceInputSchema = t.partial({
...
export const SelectionOnLaunchCodespaceSchema = t.type({
...
export const LaunchCodespaceSchema = t.type({
  launchCodespace: t.union([
    t.null,
    t.type({
      project_id: t.union([t.null, t.string]),
      project_name: t.union([t.null, t.string]),
