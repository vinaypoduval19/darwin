...
export const UpdateJobClusterDefinitionInputSchema = t.partial({
...
export const SelectionOnUpdateJobClusterDefinitionSchema = t.type({
  data: t.union([
    t.null,
...
export const UpdateJobClusterDefinitionSchema = t.type({
  updateJobClusterDefinition: t.union([
    t.null,
    t.type({
      data: t.union([
        t.null,
