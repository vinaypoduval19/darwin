...
export const CreateWorkflowInputSchema = t.partial({
  input: t.union([
    t.undefined,
    t.null,
    t.partial({
...
export const SelectionOnCreateWorkflowSchema = t.type({
  data: t.union([
    t.null,
    t.type({
      workflow_id: t.union([t.null, t.string]),
...
export const CreateWorkflowSchema = t.type({
  createWorkflow: t.union([
    t.null,
    t.type({
      data: t.union([
        t.null,
