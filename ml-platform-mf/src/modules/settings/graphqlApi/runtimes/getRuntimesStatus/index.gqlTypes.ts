...
export const GetRuntimesStatusInputSchema = t.intersection([
...
export const SelectionOnDataSchema = t.type({name: t.string, status: t.unknown})

export const SelectionOnGetRuntimesInformationSchema = t.type({
  total_records: t.number,
  page_size: t.number,
  offset: t.number,
  data: t.array(t.type({name: t.string, status: t.unknown})),
})

export const GetRuntimesStatusSchema = t.type({
